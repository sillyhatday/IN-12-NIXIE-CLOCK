...
const unsigned int SHOW_MODE_DURATION = 2000;                          // how long to show which hour mode we switched too
...
const byte TWO_DIGIT_MULTIPLEX_DUTY = 3;
...
unsigned long resetButtonPrevPush =   0;
...
void hourModeDisplay() {
    ...
    if (showMode && (millis() - showModeStart > SHOW_MODE_DURATION)) {
